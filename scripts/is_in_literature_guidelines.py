...
def main():
    ...
    for index, row in df.iterrows():
        ...
        if tag == 'Tag1':
            relevant_column = 'IsInLiteratureTag1'
        elif tag == 'Tag2':
            relevant_column = 'IsLiteratureTag2'
        else:
        ...
        try:
            ...
            if label.strip().lower() != 'accesshhh control':
                print('aaaaa')
            ...
            # Open the browser before asking for user input
                ...
                user_input = input(f"Enter 1 if the change is in guidelines, 2 otherwise, or 's' to skip for {tag}: ")
